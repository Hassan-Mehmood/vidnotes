...
export default function HomeClient({
    ...
    return (
        <>
            <HeroSection
                onExploreChannels={handleExploreChannels}
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                        {subscriptionVideos.length > 0 ? (
                                            ...
                                            <div className="col-span-full text-center py-12">
                                                ...
                                                <button
                                                    onClick={
                                                        handleExploreChannels
                                                    }
                                                    className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:from-purple-700 hover:to-blue-700 transition-all duration-300"
                                                >
                                                    Explore Channels
                                                </button>
                                            </div>
